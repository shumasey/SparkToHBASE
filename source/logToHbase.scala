...
def catalog = s"""{"table":{"namespace":"default", "name":"Logs"}, "rowkey":"key", "columns":{"ip":{"cf":"rowkey", "col":"ip", "type":"string"}, "url":{"cf":"line", "col":"url", "type":"string"}, "traffic":{"cf":"line", "col":"traffic", "type":"string"}, "date":{"cf":"line", "col":"DateTime", "type":"string"}}}""".stripMargin
// Write data to HBASE
df4.write.options(Map(HBaseTableCatalog.tableCatalog -> catalog, HBaseTableCatalog.newTable -> “5”)).format(“org.apache.spark.sql.execution.datasources.hbase”).save()